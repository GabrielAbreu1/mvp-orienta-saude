...
export function ClinicoTranquilo() {
  return (
    <div className="min-h-screen bg-white text-[#2D3748] font-['Open_Sans'] antialiased selection:bg-[#0056b3] selection:text-white overflow-x-hidden">
      ...
      <header className="py-6 px-6 md:px-12 flex justify-between items-center max-w-6xl mx-auto">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="font-['Inter'] font-bold text-xl tracking-tight text-[#0056b3] leading-none">Orienta Saúde</span>
            <span className="text-xs font-medium text-[#718096] mt-1 tracking-wide">PROJETO UNIVERSITÁRIO</span>
          </div>
        </div>
      ...
      <main className="max-w-[860px] mx-auto px-6 pt-16 md:pt-24 pb-24 text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full sm:w-auto">
            <button className="w-full sm:w-auto px-8 py-4 bg-[#0056b3] text-white rounded-2xl font-['Inter'] font-semibold text-lg hover:bg-[#004494] active:scale-[0.98] transition-all shadow-md flex items-center justify-center gap-2">
              Começar triagem <ArrowRight className="w-5 h-5" />
            </button>
            <a href="#como-funciona" className="w-full sm:w-auto px-8 py-4 bg-transparent text-[#0056b3] border-2 border-[#e2e8f0] hover:border-[#0056b3] hover:bg-[#0056b3]/5 active:scale-[0.98] rounded-2xl font-['Inter'] font-semibold text-lg transition-all flex items-center justify-center">
              Como funciona
            </a>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 mt-12 text-sm text-[#4A5568] font-semibold">
            <div className="flex items-center gap-2 bg-[#f8f9fa] px-4 py-2 rounded-xl">
              ...
              <span>Projeto acadêmico seguro</span>
            </div>
            <div className="flex items-center gap-2 bg-[#f8f9fa] px-4 py-2 rounded-xl">
              <ClipboardList className="w-4 h-4 text-[#2e8b57]" />
        ...
        <div className="mt-20 bg-[#f8f9fa] rounded-3xl p-6 md:p-8 text-left flex flex-col md:flex-row gap-6 items-start md:items-center border border-[#e2e8f0]/80 shadow-sm relative overflow-hidden">
          ...
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-3 mb-2">
              <h3 className="font-['Inter'] font-bold text-[#2D3748] text-lg">
                Avisos Importantes
              </h3>
        ...
        {/* "Como funciona" — fluxo completo em 6 passos, layout limpo e clínico */}
        <section id="como-funciona" className="mt-24 pt-16 border-t border-[#e2e8f0] text-left">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <div className="inline-flex items-center gap-2 text-sm font-semibold text-[#2e8b57] bg-[#e6f4f1] px-4 py-2 rounded-full">
              ...
              Cerca de 3 minutos do início ao resultado
            </div>
          </div>
            ...
            {[
              {
                ...
                desc: 'Você lê os termos e autoriza o uso educativo. Nada é armazenado.',
              },
              {
                icon: User,
                title: 'Sobre você',
                desc: 'Idade e gênero — usados apenas para contextualizar a orientação.',
              },
              {
                icon: Activity,
                title: 'Seleção de sintomas',
                desc: 'Marca o que está sentindo a partir de uma lista clara e objetiva.',
              },
              {
                icon: PersonStanding,
                title: 'Regiões do corpo',
                desc: 'Indica onde os sintomas se localizam para refinar a análise.',
              },
              {
                icon: MessageSquare,
                title: 'Entrevista breve',
                desc: 'De 3 a 7 perguntas curtas, geradas para o seu caso específico.',
              },
              {
                icon: ClipboardList,
                title: 'Orientação final',
                desc: 'Nível de urgência sugerido, especialidade e próximos passos.',
              },
            ].map((step, i) => {
              ...
              return (
                <li
                  ...
                  className={`flex items-start gap-5 p-5 rounded-2xl border transition-colors ${
                    isLast
                      ? 'border-[#0056b3]/20 bg-[#0056b3]/[0.03]'
                ...
                >
                  <div className="flex-shrink-0 flex flex-col items-center gap-2">
                    <div
                      className={`w-12 h-12 rounded-2xl flex items-center justify-center ${
                        isLast ? 'bg-[#0056b3] text-white' : 'bg-[#e6f4f1] text-[#2e8b57]'
                      }`}
                    >
                      <Icon className="w-6 h-6" strokeWidth={2.2} />
                    </div>
                    <span
                      className={`font-['Inter'] text-xs font-bold tracking-wider ${
                        isLast ? 'text-[#0056b3]' : 'text-[#a0aec0]'
                      }`}
                    >
                  ...
                  <div className="pt-1">
                    <h4 className="font-['Inter'] font-semibold text-lg text-[#1A202C] mb-1">
                      {step.title}
                    </h4>
          ...
          {/* O que você recebe — síntese seca do output, sem ser card-heavy */}
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              <div className="text-left">
                <div className="w-10 h-10 rounded-xl bg-[#e6f4f1] flex items-center justify-center mb-3">
                  <Gauge className="w-5 h-5 text-[#2e8b57]" />
                </div>
                <h4 className="font-['Inter'] font-semibold text-base text-[#1A202C] mb-1">Nível de urgência</h4>
                <p className="text-[#4A5568] text-sm leading-relaxed">De autocuidado a emergência, com justificativa em linguagem simples.</p>
              </div>
              <div className="text-left">
                <div className="w-10 h-10 rounded-xl bg-[#e6f4f1] flex items-center justify-center mb-3">
                  <Stethoscope className="w-5 h-5 text-[#2e8b57]" />
                </div>
                <h4 className="font-['Inter'] font-semibold text-base text-[#1A202C] mb-1">Especialidade sugerida</h4>
                <p className="text-[#4A5568] text-sm leading-relaxed">A especialidade médica mais apropriada para o conjunto de sintomas informado.</p>
              </div>
              <div className="text-left">
                <div className="w-10 h-10 rounded-xl bg-[#e6f4f1] flex items-center justify-center mb-3">
                  <Sparkles className="w-5 h-5 text-[#2e8b57]" />
                </div>
                <h4 className="font-['Inter'] font-semibold text-base text-[#1A202C] mb-1">Orientações práticas</h4>
                <p className="text-[#4A5568] text-sm leading-relaxed">O que observar, quando reavaliar e quais sinais exigem atenção imediata.</p>
              </div>
            </div>
          </div>
        </section>

        {/* Sobre o projeto — bloco curto, institucional */}
          ...
          <div className="grid md:grid-cols-[auto,1fr] gap-6 items-start text-left bg-[#f8f9fa] rounded-3xl p-6 md:p-8 border border-[#e2e8f0]/80">
            ...
            <div>
              ...
              <p className="text-[#4A5568] text-sm md:text-base leading-relaxed">
                ...
                Funciona sem cadastro, sem armazenar suas respostas e sem custo. A regra é simples: orientar com clareza, sempre apontando o caminho do atendimento profissional.
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-[#f8f9fa] border-t border-[#e2e8f0] py-12 mt-auto">
         <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex flex-col items-center md:items-start gap-1">
              ...
              <span className="text-xs text-[#a0aec0]">© {new Date().getFullYear()} Todos os direitos reservados.</span>
            </div>
