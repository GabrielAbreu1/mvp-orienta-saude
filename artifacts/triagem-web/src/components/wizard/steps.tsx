...
export function Step0Consentimento() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#e6f4f1] border border-[#2e8b57]/20 rounded-2xl p-4 flex gap-3 items-start">
        <ShieldCheck className="w-5 h-5 text-[#2e8b57] flex-shrink-0 mt-0.5" />
    ...
    >
      ...
      <div className="space-y-6">
        {categorias.map(([cat, items]) => (
          <div key={cat}>
            <h3 className="font-['Inter'] text-xs font-bold uppercase tracking-widest text-[#2e8b57] mb-3">
              {cat}
            </h3>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`${meta.bg} ${meta.border} border-2 rounded-3xl p-6 md:p-8`}
      >
      ...
      <div className="bg-white border border-[#D1E8DA] rounded-3xl p-6 md:p-8">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <span className="text-xs font-bold uppercase tracking-widest text-[#2e8b57]">
        ...
        <ul className="space-y-3">
          {resultado.orientacoesGerais.map((o, i) => (
            <li key={i} className="flex gap-3">
              <Check className="w-4 h-4 text-[#2e8b57] flex-shrink-0 mt-1" strokeWidth={3} />
      ...
      <div
        ...
        className="bg-[#fffbeb] border-2 border-[#dd6b20] rounded-3xl p-5 md:p-6 flex gap-4 items-start shadow-sm"
      >
