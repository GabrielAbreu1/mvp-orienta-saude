...
export function FeedbackForm({ resultado }: Props) {
  ...
  if (sent) {
    return (
      <div
        ...
        className="bg-[#EBF5EE] border border-[#4CAF82]/40 rounded-2xl p-8 text-center"
      >
        <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#4CAF82] text-white mb-4">
  ...
  return (
    <form
      ...
      className="bg-white border border-[#D1E8DA] rounded-2xl p-6 md:p-8 shadow-sm"
    >
      <h3 className="font-['Inter'] font-bold text-xl text-[#1A202C] mb-2">
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 rounded-2xl border-2 font-semibold text-sm transition-all ${
              util === true
                ? "border-[#4CAF82] bg-[#EBF5EE] text-[#2D7A5F]"
